...
export class Initial1685183407897 implements MigrationInterface {
    name = 'Initial1685183407897'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "paintings" ADD CONSTRAINT "FK_dc7b751ba058d939535209bf60b" FOREIGN KEY ("artistArtistId") REFERENCES "artists"("artist_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "paintings" DROP CONSTRAINT "FK_dc7b751ba058d939535209bf60b"`);
        await queryRunner.query(`ALTER TABLE "events" DROP COLUMN "time"`);
        await queryRunner.query(`ALTER TABLE "events" ADD "time" text`);
